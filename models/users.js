...
const userSchema = new mongoose.Schema(
  {
    ...
    password: {
      ...
      minlength: [8, 'Your password mast be at least 8 characters long'],
      select: false,
    },
  ...
  {
    toJSON: { virtuals: true, tiObject: { virtuals: true } },
  }
);
...
userSchema.methods.getResetPasswordToken = async function (enterPassword) {
  //generate token
